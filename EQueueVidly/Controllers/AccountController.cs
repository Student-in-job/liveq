...
namespace EQueueVidly.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public bool Confirm(string keyword)
        {
            if (keyword.Equals(ConfirmTeacher.KEYWORD))
            {
                return true;
            }
            return false;
        ...
        public FileContentResult Photo(string userId)
        {
            ...
            return user.ProfilePicture == null? null : new FileContentResult(user.ProfilePicture, "image/jpeg");
        }
